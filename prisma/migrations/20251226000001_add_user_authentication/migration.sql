...
-- CreateIndex
CREATE INDEX "SideJobLog_userId_idx" ON "SideJobLog"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "SideJobLog_userId_date_key" ON "SideJobLog"("userId", "date");
...
-- AddForeignKey
ALTER TABLE "SideJobLog" ADD CONSTRAINT "SideJobLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
